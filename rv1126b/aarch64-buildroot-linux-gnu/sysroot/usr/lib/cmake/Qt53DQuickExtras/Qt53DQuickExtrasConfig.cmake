...
set(Qt53DQuickExtras_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    set(Qt53DQuickExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickExtras_install_prefix}/include/qt5/Qt3DQuickExtras/5.15.11"
        "${_qt53DQuickExtras_install_prefix}/include/qt5/Qt3DQuickExtras/5.15.11/Qt3DQuickExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DQuickExtras_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickExtras_target_properties(RELEASE "libQt53DQuickExtras.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DQuickExtras_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuickExtras_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickExtras_check_file_exists(${imported_location})
