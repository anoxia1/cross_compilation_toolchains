...
set(Qt53DQuickAnimation_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/qt5/Qt3DQuickAnimation/5.15.11"
        "${_qt53DQuickAnimation_install_prefix}/include/qt5/Qt3DQuickAnimation/5.15.11/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "libQt53DQuickAnimation.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DQuickAnimation_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuickAnimation_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickAnimation_check_file_exists(${imported_location})
