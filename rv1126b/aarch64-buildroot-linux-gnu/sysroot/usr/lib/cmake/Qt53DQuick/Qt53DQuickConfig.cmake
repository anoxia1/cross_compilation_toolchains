...
set(Qt53DQuick_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/qt5/Qt3DQuick/5.15.11"
        "${_qt53DQuick_install_prefix}/include/qt5/Qt3DQuick/5.15.11/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    _populate_3DQuick_target_properties(RELEASE "libQt53DQuick.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DQuick_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuick_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuick_check_file_exists(${imported_location})
