...
set(Qt53DInput_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DInput)
    ...
    set(Qt53DInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DInput_install_prefix}/include/qt5/Qt3DInput/5.15.11"
        "${_qt53DInput_install_prefix}/include/qt5/Qt3DInput/5.15.11/Qt3DInput"
    )
    ...
    foreach(_module_dep ${_Qt53DInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DInput_FIND_VERSION_EXACT}
    ...
    _populate_3DInput_target_properties(RELEASE "libQt53DInput.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DInput_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DInput_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DInput_check_file_exists(${imported_location})
