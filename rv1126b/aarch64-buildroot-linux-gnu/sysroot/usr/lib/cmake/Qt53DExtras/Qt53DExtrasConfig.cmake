...
set(Qt53DExtras_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/qt5/Qt3DExtras/5.15.11"
        "${_qt53DExtras_install_prefix}/include/qt5/Qt3DExtras/5.15.11/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DExtras_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DExtras_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DExtras_check_file_exists(${imported_location})
