...
set(Qt53DQuickRender_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/qt5/Qt3DQuickRender/5.15.11"
        "${_qt53DQuickRender_install_prefix}/include/qt5/Qt3DQuickRender/5.15.11/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickRender_target_properties(RELEASE "libQt53DQuickRender.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DQuickRender_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuickRender_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickRender_check_file_exists(${imported_location})
