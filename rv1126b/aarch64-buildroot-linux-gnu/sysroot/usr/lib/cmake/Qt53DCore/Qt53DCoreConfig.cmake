...
set(Qt53DCore_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/qt5/Qt3DCore/5.15.11"
        "${_qt53DCore_install_prefix}/include/qt5/Qt3DCore/5.15.11/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    _populate_3DCore_target_properties(RELEASE "libQt53DCore.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DCore_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DCore_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DCore_check_file_exists(${imported_location})
