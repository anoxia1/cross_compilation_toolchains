...
set_target_properties(LibVNCServer::vncclient PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libvncclient.so.0.9.14"
  IMPORTED_SONAME_RELEASE "libvncclient.so.1"
  )

list(APPEND _cmake_import_check_targets LibVNCServer::vncclient )
list(APPEND _cmake_import_check_files_for_LibVNCServer::vncclient "${_IMPORT_PREFIX}/lib/libvncclient.so.0.9.14" )
...
set_target_properties(LibVNCServer::vncserver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libvncserver.so.0.9.14"
  IMPORTED_SONAME_RELEASE "libvncserver.so.1"
  )

list(APPEND _cmake_import_check_targets LibVNCServer::vncserver )
list(APPEND _cmake_import_check_files_for_LibVNCServer::vncserver "${_IMPORT_PREFIX}/lib/libvncserver.so.0.9.14" )
