...
set(Qt53DRender_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/qt5/Qt3DRender/5.15.11"
        "${_qt53DRender_install_prefix}/include/qt5/Qt3DRender/5.15.11/Qt3DRender"
    )
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DRender_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DRender_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DRender_check_file_exists(${imported_location})
