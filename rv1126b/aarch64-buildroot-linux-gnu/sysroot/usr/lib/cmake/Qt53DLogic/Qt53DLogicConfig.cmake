...
set(Qt53DLogic_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DLogic)
    ...
    set(Qt53DLogic_PRIVATE_INCLUDE_DIRS
        "${_qt53DLogic_install_prefix}/include/qt5/Qt3DLogic/5.15.11"
        "${_qt53DLogic_install_prefix}/include/qt5/Qt3DLogic/5.15.11/Qt3DLogic"
    )
    ...
    foreach(_module_dep ${_Qt53DLogic_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DLogic_FIND_VERSION_EXACT}
    ...
    _populate_3DLogic_target_properties(RELEASE "libQt53DLogic.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DLogic_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DLogic_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DLogic_check_file_exists(${imported_location})
