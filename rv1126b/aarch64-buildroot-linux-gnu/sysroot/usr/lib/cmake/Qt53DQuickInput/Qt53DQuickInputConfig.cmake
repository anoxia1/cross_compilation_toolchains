...
set(Qt53DQuickInput_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    set(Qt53DQuickInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickInput_install_prefix}/include/qt5/Qt3DQuickInput/5.15.11"
        "${_qt53DQuickInput_install_prefix}/include/qt5/Qt3DQuickInput/5.15.11/Qt3DQuickInput"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt53DQuickInput_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickInput_target_properties(RELEASE "libQt53DQuickInput.so.5.15.11" "" FALSE)
    ...
    macro(_populate_3DQuickInput_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt53DQuickInput_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_3DQuickInput_check_file_exists(${imported_location})
